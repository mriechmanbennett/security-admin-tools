...
```
Get-MSCatalogUpdate [-Search] <string> [-Architecture <string>] [-Descending] [-ExcludeFramework]
 [-FromDate <datetime>] [-Format <string>] [-GetFramework] [-AllPages] [-IncludeDynamic]
 [-IncludeFileNames] [-IncludePreview] [-LastDays <int>] [-MaxSize <double>] [-MinSize <double>]
 [-Properties <string[]>] [-SizeUnit <string>] [-SortBy <string>] [-Strict] [-ToDate <datetime>]
 [-UpdateType <string[]>] [<CommonParameters>]
```

### OS

```
Get-MSCatalogUpdate -OperatingSystem <string> [-Architecture <string>] [-Descending]
 [-ExcludeFramework] [-FromDate <datetime>] [-Format <string>] [-GetFramework] [-AllPages]
 [-IncludeDynamic] [-IncludeFileNames] [-IncludePreview] [-LastDays <int>] [-MaxSize <double>]
 [-MinSize <double>] [-Properties <string[]>] [-SizeUnit <string>] [-SortBy <string>] [-Strict]
 [-ToDate <datetime>] [-UpdateType <string[]>] [-Version <string>] [<CommonParameters>]
```
